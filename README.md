...
Python engineer building LLM agents, security-conscious architecture, and developer tooling by directing AI
tooling end to end. Based in Scotland. I publish under the alias **Eagre**.
...
- LinkedIn: [linkedin.com/in/dylanmoir](https://www.linkedin.com/in/dylanmoir/)
- Email: eagre.dev@gmail.com

<sub>*eagre — the tidal bore: the wave that runs upstream, against the current.*</sub>
